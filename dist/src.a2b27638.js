...
function _getUserData() {
  _getUserData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(id) {
    var userInfo, dbs, returnedValue;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          userInfo = {};
          _context.t0 = _databases.db1;
          _context.t1 = _databases.db2;
          _context.t2 = _databases.db3;
          _context.next = 6;
        ...
        case 10:
          ...
          _context.prev = 11;
          _context.t4 = true;
          _context.next = _context.t4 === (returnedValue == "db1") ? 15 : _context.t4 === (returnedValue == "db2") ? 26 : _context.t4 === (returnedValue == "db3") ? 37 : 48;
          break;
        case 15:
          _context.next = 17;
          return (0, _databases.db1)(id);
        case 17:
          dbs.db1 = _context.sent;
